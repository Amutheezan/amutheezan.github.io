...
In above description, we add additional variable ```transaction_flag``` which used to define whether one process is already reading the file or not. Depending on the ```transaction_flag```, when a person call ```Read``` command the person will go to 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA5MzU4MDk0NiwxOTAyMzU2NzQyLDE1OT
c0MDM2NDksLTEyNzI2MDAwODIsMTc3Nzg5MjE4NiwzNzA5NDIx
MjUsLTg2NDA0MTkyMCwtMTc0NzcyMzg2NSwtMTg2NTc4NDQ2M1
19
-->