...
Unlike previous toy example, here we can add one additional thing that is **Invariant**.
...
ForAll p1 : Proc Do
	ForAll p2 : Proc Do
		proc_state[p1].state = FB_MODIFIED & proc_state[p2].state = FB_MODIFIED
		->
			p1 = p2
	End
	End;
...
In the [next post](https://amutheezan.com/2021/06/04/murphi3.1-5.html), I will talk about how to fully extend this this extended file system.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA2ODk0MjQwMV19
-->