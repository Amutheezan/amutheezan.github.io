...
The file (or data) in main-memory and it will loaded into virtual/private memory of individual users when they call a ```Read``` or ```Write``` command. The communication happen through a bus which connects all the users and main-memory and when ever some user send either 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMDQwMTMxMywxNzcyMTcyNTgzLDIwOT
kwMzkwNjZdfQ==
-->