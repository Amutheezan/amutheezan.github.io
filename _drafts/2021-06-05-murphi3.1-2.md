...
#### Defining Rulesets
Rulesets defines the flow of the systems defined by the finite state machine, (I will discuss on another post in detail about automata and finite state machines).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI4MzE0MzQxXX0=
-->