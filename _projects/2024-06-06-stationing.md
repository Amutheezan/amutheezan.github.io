...
### 📌 Key Contributions
- **Real-time decision making:** Moved the compute budget from decision making time to compute time and achieve 1000x faster decision making while reducing response time between 5 to 13 seconds
...
- Signals the performance of high-level action via low-level critics
