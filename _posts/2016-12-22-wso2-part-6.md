...
Thus when we are doing a search based on activity id, we will get lots of data, but that should be in the order they received, not in improper order, then only it will be easy to understand by the user.
...
5. Max entries selection should be replaced with a fixed drop-down box (1000, 10000, all. etc. records)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNzg4MDEyNDcsLTM2ODQ1OTY0M119
-->