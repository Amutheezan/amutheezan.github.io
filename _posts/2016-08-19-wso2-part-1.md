...
So I replaced ```PATH``` and ```JAVA_HOME</code>``` variable in <code>```.bashrc</code>``` by redirecting to the earlier version of Java, and It worked fine.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3NTI2NDA2NiwxODI1Nzc1MjIxLDIxMj
U5ODIzMTAsLTI0NjA0MTYzOCwtMTg4MjIyMDgxXX0=
-->