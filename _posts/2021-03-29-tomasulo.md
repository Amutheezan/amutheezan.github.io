...
In this post, I have some details on my extension to a simple simulation for the Tomasulo algorithm as a part of the assignment for <strong>COSC 6385</strong> course at the University of Houston. 

This work is an extension for [existing implementation](https://github.com/qingyangqing/Tomasulo) of tomasulo algorithm with 1-issue to n-issues where n = 1,2,3,4. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM2NjQ3NTI4NCw1NTg3NjUxMjUsLTE0Nz
Y3MTg2ODIsLTI2NDIzNDk4NCw4MTg1ODU0MzddfQ==
-->
