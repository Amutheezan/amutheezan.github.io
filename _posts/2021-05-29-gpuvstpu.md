...
I have implemented following simple comparison ofn performance on Google Colab CPU, GPU, and TPU as a part of an
assignment for <strong>COSC 6385</strong> course in University of Houston.
...
Based on the results TPU performs around **1.5** times better than GPU in-terms the computation time of the CNN sample
code.
