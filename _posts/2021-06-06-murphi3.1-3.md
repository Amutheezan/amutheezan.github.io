...
The model I describe in the toy example is not fully specified. So in the real -world, it can reach a failure states. Thise purpose of these series of posts aims to get into hands with how to implement verification from specified system Mmurphi3.1.
</p>



This is the continuation of [previous post](https://amutheezan.com/formal%20methods%20and%20verification/2021/06/05/murphi3.1-2.html) which provides remaining introduction to Murphi3.1.
...
In the [next post](https://amutheezan.com/formal%20methods%20and%20verification/2021/06/07/murphi3.1-4.html), I will talk about how to extend this simple file system.

Hope you enjoyed this post.

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwOTc0OTc4NCwzMDc0MTgyMTgsMTUyNz
cxMjQwNiwxNjY3NTA2NTM0LDEzMzIyNzE3MzEsLTI5Nzc5Mzg1
NSwxNDIxMjIzNTIwLDkxMDU0MzkxMCwxMTc2NDEyNzM0XX0=
-->