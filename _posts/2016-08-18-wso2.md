...
These are <strong>series</strong> of posts containing some of the key points and ideas which I report to my university during my internship p
...
Description: When trying some examples provided in HAPI API, I had an issue with a different version of the HAPI since it recent versiod; The post is arranged by a set of reports, where each report provides the summary on tasks I have done during those four weeks of my internship and experience I gained during that period.
</p>

> **Firstn(released 4 years ago from today) v26, I mostly used v22, but some of the examples didn't support with v22, as they don't contain it.
...
> **2nderiod; The post is arranged by a set of reports, where each report provides the summary on tasks I have done during those four weeks of my internship and experience I gained during that period.
</p>

> **First Four Weeks of Internship @WSO2**  
>
> **Duration: 25th2nd of JulyAugust, 2016 to 195th of AugustSeptember, 2016**

[Report Link](https://amutheezan.com/internship/2016/08/18/wso2-part-1.html)These four weeks just another new step, in this phase I mainly deal with two concepts one is Configuring HL7 Transport with WSO2 Products Namely BAM – Business Activity Monitor and DAS – Data Analytic Server. I have already written enough about Configuring HL7 Transport in my blog post. The second stuff is comparing existing Monitoring Solutions for this I referred to a few monitoring solutions and compare it with BAM. Actually In BAM, by deploying an HL7 toolbox we can do HL7 monitoring through, BAM’s Message Console Dashboard.

Check out these links for things I have done during these 4 weeks,

1. [Configuring HL7 in WSO2 DAS](https://amutheezan.com/internship/2016/09/09/confhl7das.html) - This is related to first stuff, this explains actually how I spend my first 3 weeks to configure the HL7
2.  [HL7v3 vs FHIR](https://amutheezan.com/internship/2016/09/12/hl7v3.html) - It is not relevant but essential additional research on second stuff, to get clarity over hl7v2,v3, and FHIR.  
...
> **2n3rd Four Weeks of Internship @WSO2**  
>
> **Duration: 22nd of August, 2016 to 15th of September, 2016**

[Report Link](https://amutheezan.com/internship19th of September, 2016 to 14th of October, 2016**
...
Since I have already described the issues faced in a separate blog post; I didn't share it here. Go through that for references [1]( http://wso2.com/library/tutorials/20164/09/14/3/how-to-write-a-wso2-pcart-2.html)

> **3rd Four Weeks of Internship @WSO2**
>
> **Duration: 19th of September, 2016 to 14th of October, 2016**

[Report Link](https://amutheezan.com/internship/2016/10/13/wso2-part-3bon-component/). It was basically with dependencies and repository definition in the ```pom.xml``` file.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI3NTk2OTMzMCw1OTIzODkwMzIsLTIwNz
A5MzA5MzcsMjYzOTQ0MjM2LC0xMDY0NjE4ODc4LC0xNDc0MjA3
MzI3LC0xMDY0NjE4ODc4LC03Njc4NDExNTksLTYzNjczODU5MS
wtMjA0OTk4MDM1OSwtMTQwNzU1ODU2NywtOTEyOTkzMjg1LDE5
NjIzNzQwNTldfQ==
-->