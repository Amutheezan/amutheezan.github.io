...
Kernel page-table isolation (KPTI) (earlier referenced as KAISER) is a Linux kernel feature that protect the system from the Meltdown security vulnerability affecting mainly Intel's X86 CPU. It improves the kernel hardening against attempts to bypass the KSLR <url>[1](https://en.wikipedia.org/wiki/Kernel_page-table_isolation),  [3](https://meltdownattack.com/meltdown.pdf).
</p>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQzMTcxNzExMSwxMDQwNjc2NzEwLC04ND
k1MjU1ODEsMTUyODgwMDA4NSwyMDEwNjQwODU5LDQ2NTUxNjUw
NF19
-->