...
I looked into several suggestions, but they didn't work because I failed to figure out my exact mistake; it was only yesterday that I figured out the mistake. Back when I installed Ubuntu 16.04, I thought it may have been due to some issues related to the
...
Check this code (note this will work for a Realtek based Wi-Fi Adapter since in the third line we can see the
